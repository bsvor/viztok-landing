        ...
        <div className="max-w-6xl mx-auto mt-16 grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <a
              ...
              className="relative group rounded-xl overflow-hidden border border-white/10 aspect-[2/3] flex flex-col justify-end p-4 hover:border-cyan/50 transition-colors cursor-pointer"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <a
                  ...
                  className="relative group rounded-xl overflow-hidden border border-white/10 aspect-[3/4] flex flex-col justify-end p-4 hover:border-cyan/50 transition-colors cursor-pointer"
                >
